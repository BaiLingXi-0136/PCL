...
Public Class Settings
    ...
    Public Shared ReadOnly Entries As Dictionary(Of String, Setting) = (New List(Of Setting) From {
        ...
        New Setting("LaunchAdvanceBackupSaves", True, OnChanged:=AddressOf PageSetupLaunch.UpdateBackupSavesCount),
        New Setting("LaunchAdvanceBackupSavesCount", 2),
        ...
        New Setting("VersionAdvanceBackupSaves", 2, Source:=Sources.Instance),
        New Setting("VersionAdvanceBackupSavesCount", 2, Source:=Sources.Instance),
